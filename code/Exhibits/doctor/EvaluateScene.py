...
class EvaluateScene(Scene):
	def __init__(self, game, evaluation):
		...
		self.anotherPatientButton = Button(self.screen, pygame.Rect(904, 689, 386, 56), 
			pygame.image.load('assets/images/button-long-normal.png'), pygame.image.load('assets/images/button-long-selected.png'), 
			self.config.getText("DFAM_EVALUATION_ANOTHER_PATIENT_TEXT"), START_BUTTON_TEXT_COLOR, START_BUTTON_TEXT_COLOR, self.buttonFont, self.onAnotherPatient)
	...
	def onLanguageChanged(self):
		...
		self.createTexts()
		self.anotherPatientButton.createText(self.config.getText("DFAM_EVALUATION_ANOTHER_PATIENT_TEXT"), self.buttonFont)
