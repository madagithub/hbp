...
class CountryScene(Scene):
	...
	def draw(self, dt):
		...
		if self.institutionIndex is None:
			...
			Utilities.drawTextsOnCenterX(self.screen, self.institutionHeader, (1093 ,self.institutionHeaderY), 30)
			Utilities.drawTextsOnCenterX(self.screen, self.institutionCity, (1093 ,self.institutionCityY), 30)
			Utilities.drawTextsOnCenterX(self.screen, self.institutionDesc, (1093 ,self.institutionDescY), 30)
